...
# ==============================================================================
# Source: https://github.com/tensorflow/models/blob/master/research/inception/inception/data/build_image_data.py
...
tf.app.flags.DEFINE_string('train_directory', './Fixed/',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', './Fixed/',
...
def _process_image(filename, coder):
	...
	image = tf.Session().run(tf.image.resize_image_with_crop_or_pad(image, IMAGE_SIZE, IMAGE_SIZE))

	img = Image.fromarray(image, "RGB")
	img.save(os.path.join("./Fixed/"+str(i)+".jpeg"))
	i += 1
...
def _process_dataset(name, directory, num_shards, labels_file):
	...
	Args:
	  ...
	  labels_file: string, path to the labels file.
	"""
	print("GOT TO THIS DIRECTORY {}".format(directory))
...
def main(_):
	...
	print("MOVING ON FROM VALIDATION")
